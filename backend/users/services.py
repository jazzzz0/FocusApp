...
class ProfilePhotoService:
    ...
    def update_profile_photo(user_instance, new_photo):
        ...
        try:
            ...
            logger.error(f"Error al actualizar foto de perfil para usuario {user_instance.username}: {str(e)}")
            return False
    ...
    def remove_profile_photo(user_instance):
        ...
        try:
            ...
            logger.error(f"Error al eliminar foto de perfil para usuario {user_instance.username}: {str(e)}")
            return False
