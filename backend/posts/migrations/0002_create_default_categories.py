# Generated by Django 5.2.1 on 2024-12-01 12:00
...
def create_default_categories(apps, schema_editor):
    ...
    # Lista de categorías que queremos crear
    categories_data = [
        {
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('posts', '0001_initial'),  # Reemplaza con tu última migración
    ]
    ...
    operations = [
        migrations.RunPython(
            ...
            elidable=True,  # Se puede eliminar en producción después de aplicar
        ),
    ]
