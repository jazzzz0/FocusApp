...
export default function PostDetail() {
  ...
  const loadMoreComments = async () => {
    ...
    const nextPage = new URLSearchParams(
      commentsPagination.next.split('?')[1]
    ).get('page')
  ...
  const handleEditComment = async (commentId, newText) => {
    try {
      ...
      setSnack({
        open: true,
        message: 'No se pudo editar comentario',
        severity: 'error',
      })
    }
  }
  ...
  const handleSubmitRating = async () => {
    ...
    try {
      ...
      setSnack({
        open: true,
        message:
          err.response?.data?.message || 'No se pudo enviar la valoración',
        severity: 'error',
      })
    }
  }
    ...
    <>
      ...
      <Box sx={{ maxWidth: 800, margin: '1.5rem auto', px: 2 }}>
              ...
              <Box display="flex" alignItems="center" gap={2}>
                ...
                <Box>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    ...
                    {post.uploaded_at
                      ? new Date(post.uploaded_at).toLocaleDateString('es-ES')
                      : 'Fecha desconocida'}
                  </Typography>
                </Box>
              </Box>
                ...
                {commentsPagination.next ? (
                  <Box display="flex" justifyContent="center" mt={2}>
                    <Button
                      ...
                      sx={{ minWidth: 120 }}
                    >
                      {commentsPagination.loadingMore
                        ? 'Cargando...'
                        : 'Ver más comentarios'}
                    </Button>
                  </Box>
        ...
        >
          ...
          <DialogContent>
            <Typography variant="body2" color="text.secondary">
              Puntúa cada aspecto de 1 a 5 estrellas
            </Typography>
            <Typography
              variant="caption"
              color="text.secondary"
        ...
        >
          ...
          <DialogContent>
            ...
            <Typography variant="body2" color="text.secondary">
              ...
              comentarios y valoraciones asociados.
            </Typography>
          </DialogContent>
          <DialogActions>
            <Button
        ...
        <Snackbar
          open={snack.open}
          autoHideDuration={
            snack.message.includes('eliminada correctamente') ? 2000 : 3000
          }
