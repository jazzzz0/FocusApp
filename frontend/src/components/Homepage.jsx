              ...
              {user ? (
                ...
                <>
                  ...
                  <p className="welcome-description">
                    Sigue compartiendo tu creatividad y conectando con otros
                    fotógrafos apasionados. Explora nuevas ideas, inspira y
                    déjate inspirar. Tu próxima gran captura te está esperando.
                  </p>
                </>
              ) : (
                ...
                <>
                  ...
                  <p className="welcome-description">
                    Descubre, comparte y conecta con fotógrafos de todo el
                    mundo. Sube tus mejores capturas y forma parte de una
                    comunidad apasionada por el arte visual.
                  </p>
      ...
      <section className="about" id="about">
        ...
        <div className="row">
          ...
          <div className="about-description">
            ...
            <p>
              FocusApp es una comunidad digital para fotógrafos, donde podrás
              compartir tus obras, recibir puntuaciones, participar en concursos
              y aprender junto a otros apasionados por la fotografía.
            </p>
            <a onClick={scrollToFunctions} className="btn">
              Explorar funciones
            </a>
          </div>
        </div>
          ...
          {[
            {
              img: perfil,
              title: 'Perfil',
              desc: 'Mostrá tu portfolio fotográfico para que la comunidad pueda conocerte.',
            },
            {
              img: subir,
              title: 'Publicación de Fotos',
              desc: 'Subí tus mejores capturas y compartí tu creatividad con el mundo.',
            },
            {
              img: puntuacion,
              title: 'Valoraciones de la Comunidad',
              desc: 'Recibí puntuaciones y comentarios genuinos de otros usuarios para mejorar tu trabajo.',
            },
            {
              img: categoria,
              title: 'Explorá por Categorías',
              desc: 'Descubrí fotografías clasificadas por temáticas para inspirarte o participar.',
            },
            {
              img: ranking,
            ...
            },
            {
              ...
              desc: 'Opiná y aprendé de los demás dejando comentarios constructivos en cada foto.',
            },
          ].map((func, i) => (
